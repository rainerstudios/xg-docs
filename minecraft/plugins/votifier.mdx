...
Likewise from the previous step, each server that requires voting functionality will also require a vote listener plugin as well. Refer to [this section](#configure-rewards) for popular and recommended choices. 
