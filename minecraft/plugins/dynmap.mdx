---
  title: "Dynmap: Google Maps for your Minecraft Server"
  sidebarTitle: "Dynmap"
  description: "A guide to use Dynmap to create and view a live map of your Minecraft server."
---

[Dynmap®](https://github.com/webbukkit/dynmap) is a Bukkit plugin (and a mod), which can be used to view a live map of the server's worlds in a browser.
...
1. Download the latest version of Dynmap from [SpigotMC](https://www.spigotmc.org/resources/dynmap%C2%AE.274/) (if you're running Paper, SpigotMC; any Bukkit forks), or [CurseForge](https://www.curseforge.com/minecraft/mc-mods/dynmapforge) (if you're running a modded server).
