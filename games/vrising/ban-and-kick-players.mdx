...
If you need to temporarily or permanently remove a player from your [V Rising dedicated server](https://xgamingserver.com/v-rising-server-hosting), you can use server commands or edit the ban list file.
