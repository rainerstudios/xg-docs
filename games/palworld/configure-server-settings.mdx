...
Need help configuring settings on your [Palworld server](https://xgamingserver.com/palworld-server-hosting)? Shoot us a message on our [community Discord server](https://xgamingserver.com/discord) or [contact support](https://xgamingserver.com/support).