...
The new [Palworld Sakurajima update](https://blog.berrybyte.net/palworld-sakurajima-update-released/) brings [Xbox dedicated servers](https://berrybyte.net/palworld-server-hosting), and with you'll need to know how to connect and join your Palworld server on Xbox.
...
Allow the server a few moments to accept the connection and then voilà, you should now be able to join your Palworld server from Xbox!
