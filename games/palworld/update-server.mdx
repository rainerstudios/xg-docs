...
Luckily, we've simplified the whole process for you to a single click of a button at [BerryByte](https://berrybyte.net/palworld)!

## Updating Palworld Server

1. Login to the [game panel](https://game.berrybyte.net)
2. In the **Settings** tab, make sure **Auto Update** is enabled
