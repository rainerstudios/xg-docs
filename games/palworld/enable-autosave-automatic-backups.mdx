...
To enable autosaves on your [XGamingServer](https://xgamingserver.com) server, follow these steps:
...
Need help setting up backups for your [Palworld dedicated server](https://xgamingserver.com/palworld-server-hosting)? Shoot us a message in our
[community Discord server](https://xgamingserver.com/discord) or [contact the Berry team](https://xgamingserver.com/support).