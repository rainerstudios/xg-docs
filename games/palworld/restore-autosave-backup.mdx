...
Lost your server's save data, bases, character progress or need to rollback in time? Has your [Palworld server](https://berrybyte.net/palworld-server-hosting) been wiped and is prompting you to create a new character?
...
<Frame>
  <img src="/images/palworld-select-backup.png" />
</Frame>
5. Press **Archive**, and **move the archive** to `/Pal/Saved/SaveGames`
<Frame>
  <img src="/images/move-archive.png" />
</Frame>
...
Need help restoring backups for your [Palworld dedicated server](https://berrybyte.net/palworld-server-hosting)? Shoot us a message in our
