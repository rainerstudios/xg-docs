...
To get started with installing your favourite modpack on your Minecraft server, first, [upload the modpack's server archive](../lime/importing-files) (usually in a `.zip` format) to your file manager on the [game panel](https://game.berrybyte.net).
