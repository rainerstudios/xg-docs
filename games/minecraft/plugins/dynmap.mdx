...
5. Port-forward Dynmap's web interface (this is done in your router's configuration if you're running your Minecraft server locally. Otherwise this can done in the Network tab on [Lime](https://game.berrybyte.net/)).
