...
Looking to convert your Minecraft world into a different version? [Chunker](https://chunker.app/) is a free website that allows you to upload worlds and convert a Minecraft Java world to Bedrock Edition and a Bedrock world to Java Edition. This tool has been developed by the [HiveMC](https://playhive.com) team. This [BerryByte](https://berrybyte.net/minecraft) guide will show you how to use Chunker to convert your world and use it within a couple minutes!
